...
RADIUS = 0.02        # 半径 2 cm     m
LENGTH = 0.25        # 长度 25 cm    m
...
N_FINE = 400         # 细网格单元数，须为 N_OUT 的整数倍
...
def cell_weights(n_fine, hx):
    ...
    注意 r_0 = 0，直接用 r_i*hx 会把中心控制体权重记成 0，导致守恒检验出现虚假残差。
    """
